...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                <li class="active wow zoomIn"><a href="menu_admin.php">Editar Asignatura</a></li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6">
                <h3 class="animated pulse">Editar Asignatura. <text class="text-success"><?=Normalizer::output_normalize_name( $_SESSION[ 'subject_data' ][ 'nombre' ] )?></text></h3>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-lg-3"></div>
                <div class="col-lg-6">
                    <form id="data_course" action="../services/admin/edit_subject.php" method="POST" role="edit" data-toggle="validator">
                        
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="name" class="control-label text-info">Nombre*</label>
                                <input type="text" class="form-control" id="name" name="name" value='<?=Normalizer::output_normalize_name( $_SESSION[ 'subject_data' ][ 'nombre' ] )?>' required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="5" id="description" name="description"><?=Normalizer::output_normalize_paragraph( $_SESSION[ 'subject_data' ][ 'descripcion' ] )?></textarea>
                            <div class="help-block with-errors" delay="1000"></div>
                        </div>
