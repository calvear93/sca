...
<head>
    ...
    <?php
        ...
        $_SESSION[ 'score_data' ] = DataGetter::get_score_data( $_SESSION[ 'db_connection' ], $_COOKIE[ 'score_focused' ] );

        $description = Normalizer::output_normalize_paragraph( $_SESSION[ 'score_data' ][ 'descripcion' ] );
    ?>
</head>
...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                <li class="active wow zoomIn"><a href="#">Editar Calificación</a></li>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <form id="data_student" action="../services/teacher/edit_score.php" method="POST" role="register" data-toggle="validator">
                <div class="col-lg-12">
                <p class="text-success">Ingrese los datos la calificación.</p>
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="score" name="score" value=<?=$_SESSION[ 'score_data' ][ 'valor' ]?> required>
