...
<html lang="es">
<head>
    <title>Lista Profesores Inhabilitados</title>
    <meta charset="utf-8">
    ...
    <?php
        ...
        session_start();
        $_SESSION[ 'table_name' ] = ( new TableGetter() )->save_teacher_list_disabled();
    ?>
</head>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                <li class="active wow zoomIn"><a href="#">Lista Profesores Inhabilitados</a></li>
