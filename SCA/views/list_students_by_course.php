...
<head>
    ...
    <?php
        ...
        $_SESSION[ 'table_name' ] = ( new TableGetter() )->save_student_list_by_course( $_COOKIE[ 'course_focused' ] );
...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                <li class="active wow zoomIn"><a href="#" data-toggle="popover" data-trigger="hover" data-placement="bottom" data-content='<?=$level?>'>Lista Estudiantes</a></li>
    ...
    <ul id="context-menu" class="dropdown-menu animated pulse">
        ...
        <li role="separator" class="divider"></li>
        <li data-item="unenroll"><a>Desmatricular de Curso</a></li>
            ...
            $( '#students' ).bootstrapTable( {
                ...
                onContextMenuItem: function( row, $student ) {
                    switch( $student.data("item") ) {
                        ...
                        case "unenroll":
                            set_cookie( 'student_focused', row.run );
                            window.location.href = "../services/admin/unenroll_student.php";
                        break;
                        case "see_profile":
                            set_cookie( 'student_focused', row.run );
