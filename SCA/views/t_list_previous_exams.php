...
<html lang="es">
<head>
    <title>Lista Evaluaciones Anteriores</title>
    <meta charset="utf-8">
    ...
    <?php
        ...
        session_start();
        $_SESSION[ 'table_name' ] = ( new TableGetter() )->save_historical_exam_list_by_teacher( $_COOKIE[ 'session_user' ] );
    ?>
</head>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                <li class="active wow zoomIn"><a href="#">Lista Evaluaciones Anteriores</a></li>
