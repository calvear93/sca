...
<body>
        ...
        <div class="row">
            ...
            <div class="panel panel-default animated pulse">
                <div class="panel-body">
                    <p class="text-info"><strong>En este sistema usted podrá gestionar los datos de
                    profesores, estudiantes, cursos y asignaturas.</strong></p>
                </div>
    ...
    <script src="styles/js/scripts/notify-cases-admin.js"></script>
