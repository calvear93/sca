...
<html lang="es">
<head>
    <title>Gráfico de Rendimiento Académico</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="styles/css/jquery.jqplot.min.css">
    ...
    <script src="styles/js/jquery.jqplot.min.js"></script>
    ...
    <?php
        ...
        $_SESSION[ 'course_averages' ] = DataGetter::get_averages_list_by_course( $_SESSION[ 'db_connection' ], $_SESSION[ 'student_data' ][ 'curso_actual' ] );
    ?>
</head>
