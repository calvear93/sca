...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                <li class="active wow zoomIn"><a href="main_admin.php">Registrar Curso</a></li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6">
                <h3 class="animated pulse">Registrar Curso.</h3>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-lg-3"></div>
                <div class="col-lg-6">
                    <form id="data_course" action="../services/admin/register_course.php" method="POST" role="register" data-toggle="validator">
                        
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="digid" class="control-label text-info">Letra*</label>
                                <input type="text" class="form-control" id="digid" name="digid" placeholder="Ingrese Letra"
                                    ...
                                    <select class="selectpicker show-tick" data-size="8" data-style="btn-inverse" data-live-search="true" id="level" name="level">
                                        <?php
                                            foreach ( $_SESSION[ 'level_list' ] as $level )
                                                echo '<option>' . $level[ 'grado' ] . "° " .
                                                    Normalizer::output_normalize_name( $level[ 'nivel' ] ) . '</option>';
                                        ?>
                                    </select>
                                </div>
                            </div>
