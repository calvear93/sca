...
<head>
    ...
    <?php
        ...
        $_SESSION[ 'table_name' ] = ( new TableGetter() )->save_subject_list_by_course( $_COOKIE[ 'course_focused' ] );
...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                <li class="active wow zoomIn"><a href="#" data-toggle="popover" data-trigger="hover" data-placement="bottom" data-content='<?=$level?>'>Lista Asignaturas</a></li>
    ...
    <ul id="context-menu" class="dropdown-menu animated pulse">
        ...
        <li role="separator" class="divider"></li>
        <li data-item="unlink"><a>Desvincular profesor</a></li>
                ...
                onContextMenuItem: function( row, $subject ) {
                    switch( $subject.data("item") ) {
                        case "edit":
                            ...
                            window.location.href = "edit_subject.php";
                        break;
                        case "unlink":
                            set_cookie( 'subject_focused', row.id );
