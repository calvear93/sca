...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                <li class="active wow zoomIn"><a href="#">Registrar Evaluación</a></li>
    ...
    <div class="container">
        <div class="row">
            <h3 class="animated pulse">Registrar Evaluación.</h3>
        </div>
        <div class="row">

            <form id="data_student" action="../services/teacher/register_exam.php" method="POST" role="register" data-toggle="validator">
                <div class="col-lg-6">
                <p class="text-success">Ingrese los datos la evaluación.</p>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="input-group clockpicker">
                            <input type="text" class="form-control" name="time_start" value="00:00"></input>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="input-group clockpicker">
                            <input type="text" class="form-control" name="time_end" value="00:00"></input>
