...
<head>
    ...
    <?php
        ...
        $_SESSION[ 'table_name' ] = ( new TableGetter() )->save_teacher_list_by_course( $_COOKIE[ 'course_focused' ] );

        $course =  DataGetter::get_course_data( $_SESSION[ 'db_connection' ], $_COOKIE[ 'course_focused' ] );
...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                <li class="active wow zoomIn"><a href="#" data-toggle="popover" data-trigger="hover" data-placement="bottom" data-content='<?=$level?>'>Lista Profesores</a></li>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="container animated bounceInUp">
                <div class="row">
                    <table id='teachers' data-pagination="true" data-page-size="12"
                    ...
                    data-url=<?=$_SESSION[ 'table_name' ]?>>
                        <thead>
                            <tr>
                                ...
                                <th data-field='titulo' data-formatter="string_normalizer">Título</th>
                            </tr>
                        </thead>
                    </table>
                </div>  
    ...
    <ul id="context-menu" class="dropdown-menu animated pulse">
        <li data-item="edit"><a>Editar</a></li>
        <li role="separator" class="divider"></li>
        <li data-item="enable"><a>Vincular a asignatura</a></li>
        <li data-item="disable"><a>Desvincular de asignatura</a></li>
        <li role="separator" class="divider"></li>
        <li data-item="see_profile"><a>Ver más datos</a></li>
    </ul> 
    
    <script src="styles/js/scripts/confirm-dialogs.js"></script>
    
    <script>
        delete_cookie( 'teacher_focused' );
        $('[data-toggle="popover"]').popover();
        $( function() {
            $( '#teachers' ).bootstrapTable( {
                contextMenu: '#context-menu',
                onContextMenuItem: function( row, $teacher ) {
                    switch( $teacher.data("item") ) {
                        case "edit":
                            set_cookie( 'teacher_focused', row.run );
                            window.location.href = "edit_teacher.php";
                        break;
                        case "link":
                            set_cookie( 'teacher_focused', row.run );
                            window.location.href = "../services/admin/link_teacher.php";
                        break;
                        case "unlink":
                            set_cookie( 'teacher_focused', row.run );
                            window.location.href = "../services/admin/unlink_teacher.php";
                        break;
                        case "see_profile":
                            set_cookie( 'teacher_focused', row.run );
                            window.location.href = "show_teacher.php";
                        break;
                    }
                }
            });
