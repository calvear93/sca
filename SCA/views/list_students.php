...
<head>
    ...
    <?php
        ...
        session_start();
        $_SESSION[ 'table_name' ] = ( new TableGetter() )->save_student_list();
    ?>
</head>
...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                <li class="active wow zoomIn"><a href="#">Lista Estudiantes</a></li>
    ...
    <ul id="context-menu" class="dropdown-menu animated pulse">
        ...
        <li role="separator" class="divider"></li>
        <li data-item="enroll"><a>Matricular en Curso</a></li>
            ...
            $( '#students' ).bootstrapTable( {
                ...
                onContextMenuItem: function( row, $student ) {
                    switch( $student.data("item") ) {
                        ...
                        case "enroll":
                            set_cookie( 'student_focused', row.run );
                            window.location.href = "list_courses_to_enroll.php";
                        break;
                        case "unenroll":
                            set_cookie( 'student_focused', row.run );
