...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                <li class="active wow zoomIn"><a href="#">Inicio</a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu animated pulse">
                        <li><a id="change_password" href="e_see_profile.php"><span class="glyphicon glyphicon-user"></span>  Ver Perfil</a></li>
    ...
    <div class="container">
        <div class="row">
            <h3 class="animated pulse">¡Bienvenido a SCA!</h3>
        </div>
        <div class="row">

            <div class="panel panel-default animated pulse">
                <div class="panel-body">
                    <p class="text-info"><strong>En este sistema usted podrá visualizar su rendimiento académico.</strong></p>
                </div>
                <div class="panel-footer"><small>SISTEMA DE COMUNICACIÓN ACADÉMICA<s/mall></div>
            </div>
    ...
    <script src="styles/js/scripts/notify-cases-student.js"></script>
