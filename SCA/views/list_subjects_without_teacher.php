...
<html lang="es">
<head>
    <title>Lista Asignaturas sin Profesor</title>
    <meta charset="utf-8">
    ...
    <?php
        ...
        session_start();
        $_SESSION[ 'table_name' ] = ( new TableGetter() )->save_subject_list_without_teacher();
    ?>
</head>
...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                <li class="active wow zoomIn"><a href="#">Lista Asignaturas sin Profesor</a></li>
    ...
    <ul id="context-menu" class="dropdown-menu animated pulse">
        <li data-item="link"><a>Vincular asignatura a profesor</a></li>
        <li role="separator" class="divider"></li>
