...
<head>
    ...
    <?php
        ...
        session_start();
        $_SESSION[ 'table_name' ] = ( new TableGetter() )->save_teacher_list();
    ?>
</head>
...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                <li class="active wow zoomIn"><a href="#">Lista Profesores</a></li>
    ...
    <ul id="context-menu" class="dropdown-menu animated pulse">
        ...
        <li role="separator" class="divider"></li>
        <li data-item="enable"><a>Habilitar</a></li>
        <li data-item="disable"><a>Inhabilitar</a></li>
        <li role="separator" class="divider"></li>
        <li data-item="link"><a>Vincular a asignatura</a></li>
        <li data-item="unlink"><a>Desvincular de asignatura</a></li>
        <li role="separator" class="divider"></li>
            ...
            $( '#teachers' ).bootstrapTable( {
                ...
                onContextMenuItem: function( row, $teacher ) {
                    switch( $teacher.data("item") ) {
                        ...
                        case "enable":
                            set_cookie( 'teacher_focused', row.run );
                            window.location.href = "../services/admin/enable_teacher.php";
                        break;
                        case "disable":
                            set_cookie( 'teacher_focused', row.run );
                            window.location.href = "../services/admin/disable_teacher.php";
                        break;
                        case "link":
                            set_cookie( 'teacher_focused', row.run );
                            window.location.href = "list_subjects_without_teacher.php";
                        break;
                        case "unlink":
                            set_cookie( 'teacher_focused', row.run );
                            window.location.href = "list_subjects_by_teacher.php";
                        break;
                        case "see_profile":
                            set_cookie( 'teacher_focused', row.run );
