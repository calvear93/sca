...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                <li class="active wow zoomIn"><a href="#">Lista Cursos</a></li>
    ...
    <ul id="context-menu" class="dropdown-menu animated pulse">
        ...
        <li role="separator" class="divider"></li>
        <li data-item="see_students"><a>Ver Lista de Estudiantes</a></li>
        <li data-item="see_teachers"><a>Ver Lista de Profesores</a></li>
        <li data-item="see_subjects"><a>Ver Lista de Asignaturas</a></li>
    </ul> 
            ...
            $( '#courses' ).bootstrapTable( {
                ...
                onContextMenuItem: function( row, $course ) {
                    switch( $course.data("item") ) {
                        ...
                        case "see_students":
                            set_cookie( 'course_focused', row.id );
                            window.location.href = "list_students_by_course.php";
                        break;
                        case "see_teachers":
                            set_cookie( 'course_focused', row.id );
                            window.location.href = "list_teachers_by_course.php";
                        break;
                        case "see_subjects":
                            set_cookie( 'course_focused', row.id );
                            window.location.href = "list_subjects_by_course.php";
                        break;
                    }
                }
            });
