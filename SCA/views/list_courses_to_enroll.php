...
<html lang="es">
<head>
    <title>Lista Cursos para Matricular</title>
    <meta charset="utf-8">
    ...
    <?php
        ...
        $_SESSION[ 'table_name' ] = ( new TableGetter() )->save_course_list();

        $student = DataGetter::get_student_data( $_SESSION[ 'db_connection' ], $_COOKIE[ 'student_focused' ] );
        
        $run_student = Normalizer::output_normalize_run( $student[ 'run' ] );
    ?>
</head>
...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                <li class="active wow zoomIn"><a href="#" data-toggle="popover" data-trigger="hover" data-placement="bottom" data-content='Estudiante: <?=$run_student?>'>Lista Cursos para Matricular</a></li>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="container animated bounceInUp">
                <div class="row">
                    <table id='courses' data-pagination="true" data-page-size="12"
                    ...
                    data-url=<?=$_SESSION[ 'table_name' ]?>>
                        <thead>
                            <tr>
                                ...
                                <th data-field='nivel' data-formatter="string_normalizer">Nivel</th>
                                <th data-field='letra' data-formatter="string_normalizer">Letra</th>
                            </tr>
                        </thead>
                    </table>
                </div>  
    ...
    <ul id="context-menu" class="dropdown-menu animated pulse">
        <li data-item="enroll"><a>Matricular Estudiante Aquí</a></li>
    </ul> 
    
    <script src="styles/js/scripts/confirm-dialogs.js"></script>
    
    <script>
        delete_cookie( 'course_focused' );
        $('[data-toggle="popover"]').popover();
        $( function() {
            $( '#courses' ).bootstrapTable( {
                contextMenu: '#context-menu',
                onContextMenuItem: function( row, $course ) {
                    switch( $course.data( "item" ) ) {
                        case "enroll":
                            set_cookie( 'course_focused', row.id );
                            window.location.href = "../services/admin/enroll_student.php";
                        break;
                    }
                }
            });
